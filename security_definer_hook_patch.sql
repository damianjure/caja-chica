-- security_definer_hook_patch.sql
-- Aplica SECURITY DEFINER al hook de auth (alto #16 auditoría 2026-05-03).
-- El fix_auth_hook.sql ya lo tenía; este patch lo hace idempotente en schema base.
--
