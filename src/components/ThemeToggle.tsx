...
export function ThemeToggle({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm font-medium text-neutral-700 shadow-sm hover:border-[var(--app-text-2)] ${compact ? '' : 'min-w-[132px] justify-center'}`}
    >
