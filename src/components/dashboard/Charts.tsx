      ...
      {items.map((item) => (
        <div key={item.label} className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4">
          ...
          <div className="space-y-2">
            <div>
              <div className="mb-1 flex items-center justify-between"><span className="text-[11px] font-medium uppercase tracking-widest text-neutral-500">Presupuesto</span><span className="text-xs font-semibold text-neutral-900 tabular-nums">{formatCompact(item.budget)}</span></div>
            ...
            <div>
              <div className="mb-1 flex items-center justify-between"><span className="text-[11px] font-medium uppercase tracking-widest text-neutral-500">Real</span><span className="text-xs font-semibold text-red-600 tabular-nums">{formatCompact(item.actual)}</span></div>
