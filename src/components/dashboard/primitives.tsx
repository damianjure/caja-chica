...
export function KpiBadgeCard({
  ...
  return (
    <div className="flex items-center gap-4 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-1)] px-5 py-4 shadow-[var(--app-shadow-sm)]">
      <div className="h-10 w-10 shrink-0 rounded-xl bg-[color-mix(in_srgb,var(--app-strong-surface)_10%,var(--app-surface-2))] flex items-center justify-center">
      ...
      <div className="min-w-0">
        ...
        {sub && <div className="text-xs text-[var(--app-text-3)] mt-1 truncate">{sub}</div>}
      </div>
    </div>
  );
}
