                ...
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-[var(--app-red-border)] text-[var(--chart-expense)] transition hover:border-red-400 disabled:opacity-50"
                    >
