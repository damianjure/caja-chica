        ...
        return (
          <div className="rounded-xl border border-[var(--app-border)] overflow-hidden">
            {activeMembers.map((member) => {
              ...
              if (activeLink) {
                pill = <span className="inline-flex items-center rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-[var(--chart-income)] dark:bg-green-500/15 dark:text-green-200">Vinculado</span>;
              } else if (pendingLink) {
