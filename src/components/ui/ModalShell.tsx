  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={`anim-scale-in w-full ${SIZE_CLASSES[size]} max-h-[90vh] bg-[var(--app-surface-1)] rounded-2xl shadow-[var(--app-shadow-md)] border border-[var(--app-border-strong)] overflow-hidden flex flex-col`}
