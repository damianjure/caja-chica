...
export function getCategorySummaries(history: Movimiento[], companyName?: string) {
  ...
  // ⚡ Bolt: Using a single for...of loop instead of chained .filter().forEach()
  // Impact: Prevents intermediate array allocations and reduces iteration overhead for large datasets.
