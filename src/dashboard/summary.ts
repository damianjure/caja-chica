...
export function getCategorySummaries(history: Movimiento[], companyName?: string) {
  ...
  // ⚡ Bolt Optimization: Using a single for...of loop instead of .filter().filter().forEach()
  // Reduces intermediate array allocations and iteration overhead on large datasets.
